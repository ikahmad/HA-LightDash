...
3. Update `RELEASE.md` with a user-friendly, non-technical summary — brief intro sentence per version categorising the type of change, then bulletpoints describing what it means for the user (not implementation details)
