...
Check out the docs for full details on setting up the addon.
...
![Alarm card](https://github.com/richkershaw/HA-LightDash/raw/main/example-images/example-alarm.png)
